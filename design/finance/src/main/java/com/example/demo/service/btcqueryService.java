...
@Service
public class btcqueryService {//比特币价格查询service
    ...
    public List<btcprice> getBtcpriceList(){//读比特币价格信息表
    ...
    public List<btcprice> getBtcpriceListToday(){//读今日的比特币价格信息表
       ...
       // String sql="select * from btc_price";
        ...
        String sql="select * from btc_price where time like '"+today+"%'";
        return(List<btcprice>) jdbcTemplate.query(sql, new RowMapper<btcprice>() {
            @Override
            public btcprice mapRow(ResultSet rs, int rowNum) throws SQLException{
                btcprice price=new btcprice();
    ...
    public List<btcprice> getBtcpriceList3day(){//读3日的比特币价格信息表
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd");
        String today=simpleDateFormat.format(DateUtils.getDayBegin());
        Date date = new Date();
        ...
        // String sql="select * from btc_price";
        //String sql="select * from btc_price where time like '"+today+"%0' or time like '"+today+"%5'";
        String sql="select * from btc_price where time like '"+today+"%0' or time like '"+today+"%5'"+"or time like '"+yesterday+"%0'"+"or time like '"+yesterday+"%5'"+"or time like '"+qianday+"%0'"+"or time like '"+qianday+"%5'";
    ...
    public List<btcprice> getBtcpriceList7day(){//读7日的比特币价格信息表
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd");
        String today=simpleDateFormat.format(DateUtils.getDayBegin());
        Date date = new Date();
        String yesterday=simpleDateFormat.format(DateUtils.getFrontDay(date,1));//昨天
        ...
        // String sql="select * from btc_price";
        //String sql="select * from btc_price where time like '"+today+"%0' or time like '"+today+"%5'";
        String sql="select * from btc_price where time like '"+today+"%0' or time like '"+today+"%5'"+"or time like '"+yesterday+"%0'"+"or time like '"+yesterday+"%5'"+"or time like '"+qianday+"%0'"+"or time like '"+qianday+"%5'"+"or time like'"+daQianday+"%0'"+"or time like '"+daQianday+"%5'"+"or time like '"+biggerQianday+"%0'"+"or time like '"+biggerQianday+"%5'"+"or time like '"+biggestQianday+"%0'"+"or time like '"+biggestQianday+"%5'"+"or time like '"+biggerThanBiggestqianday+"%0'"+"or time like '"+biggerThanBiggestqianday+"%5'";
